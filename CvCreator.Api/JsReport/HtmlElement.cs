    ...
    public class HtmlElement
    {
        ...
        public string GetElement()
        {
            return $"<div  style=\"" + style.GetStyle() + "\">"
                ...
                + $"<img alt=\"\" onerror=\"this.style.display = 'none'\" style=\" z-index: {zIndex-1};position: absolute; top: 0; left: 0; padding: 0; margin-top: 0; vertical-align: middle; max-height: 100%; \" src=\"{imagePath}\" />"
